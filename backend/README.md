...
## Project Structure
    ...
    ├── distributor_kpi_das_37565  # Django project configurations
...
1. Clone this repo and `cd distributor_kpi_das_37565`
...
2. Clone this repo and `cd distributor_kpi_das_37565`
